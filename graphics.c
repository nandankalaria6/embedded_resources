...
{
    uint16_t index = x + 128*(y/8);
    // y/8=> dar ek page ma 8 bits
    if(colour) buffer[index] |= (1<<y%8);
...
void clearBuffer()
{
    ...
    {
        buffer[i]=0x00;//akha dispay ma 0
    }
}
...
void drawChar(uint8_t x, uint8_t y, char c)
{
     ...
     for(uint8_t col = 0; col < 5; col++)
    {
        ...
        // go to x,y and print the charcter 7 pixels at a time(5 times)
    }
}
